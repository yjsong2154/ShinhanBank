  ...
  all: [
    {
      ...
      content: '[광고] 설 선물은? 설하수가 정한 명품으로 하니 안심하고 구매하세요 😊',
      date: '9시간 전',
    },
    {
      id: 2,
      type: '광고',
      title: '무료쿠폰!❤️',
      content: '[광고] 원로그가 드리는 월세 할인 쿠폰! 80% 할인! 지금 바로 받아가세요',
      date: '2시간 전',
    },
    {
      id: 3,
      ...
      content: '[광고] 최근 접속한 한정판 에어팟 프로 13,000₩ 쿠폰 받고 바로 GO!',
      date: '어제 10:00',
    },
    {
      id: 4,
      type: '광고',
      title: '오늘만! ❤️',
      content: '[광고] 랭킹 보상 쿠폰! 랭킹1등하면 모든 혜택을 1년 동안 누릴 수 있습니다! 당첨자는?',
      date: '어제 14:00',
    },
  ],
  event: [
